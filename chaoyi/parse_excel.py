...
class ExcelParser:
    def __init__(self,db_name,filename):
        ...
        self.mysql_helper = MySQLHelper(host='localhost',user='root',password='123456')
    ...
    def create_db(self):
        ...
        self.mysql_helper = MySQLHelper(host='localhost',user='root',password='123456',database=self.db_name)
